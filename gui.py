...
class Uibot(Thread):
    ...
    def takeCommand(self):
        # it takes micro phone ip from the user and return string op
        lr = sr.Recognizer()
        with sr.Microphone() as source:
            lr.adjust_for_ambient_noise(source, duration=0.2)
            print("Listening...")
            lr.pause_threshold = 1
            audio = lr.listen(source)
        try:
            print("Recognizing...")
            query = lr.recognize_google(audio, language="en-in")
                ...
                with sr.Microphone() as source2:
                    ...
                    if "wikipedia" in query:
                        ...
                        try:
                            ...
                            self.speak("tell me the name to whome you want to send the message")
                            ...
                            print(e)
                            self.speak("sorry sir I am not able to send email")
                        ...
                        self.speak("searching for results in google")
                        try:
                        ...
                        for j in search(query, tld="co.in", num=10, stop=10, pause=2):
                            print(j)
                        self.speak("sir, here are the results according to google")




                    elif "calendar" in query:
                        self.speak("tell me the year")
                        print("tell me the year")
                        yy = int(self.takeCommand().lower())
                        self.speak("tell me the month in digit")
                        print("tell me the month in digit")
                        mm = int(self.takeCommand().lower())
                        print("sir,the calender is shown bellow:")
                        self.speak("sir,the calender is shown bellow:")
                        ...
                        self.speak("visual studio code is opening")
                        codpath = "C:\\Users\\Ankit\\AppData\\Local\\Programs\\Microsoft VS Code\\Code.exe"
                        ...
                        self.speak("enter the mobile number which you want to trace")
                        mc['mobilenumber'] = str(
                        ...
                        self.speak("press q for closing the camera")
